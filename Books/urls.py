...
urlpatterns = [
    ...
    path(
        "api/books/genre/create/",
        API_views.CreateGenre.as_view(),
        name="books-create-genre",
    ),
    path("api/books/create/", API_views.CreateBook.as_view(), name="books-create"),
    path(
        "api/books/recommend/public/",
        API_views.PublicRecommendBooks.as_view(),
        name="books-recommend-public",
    ),
    path(
        "api/books/recommend/private/",
        API_views.PrivateRecommendBooks.as_view(),
        name="books-recommend-private",
    ),
